...
resourcename="homehardware"  # lower case, only
resourcegroup="homehardware_rg"
...
# git clone https://github.com/apilogicserver/homehardware.git
# cd homehardware
...
az group create --name homehardware_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group homehardware_rg --sku S1 --is-linux
az container create --resource-group homehardware_rg --name homehardware --image apilogicserver/homehardware:latest --dns-name-label homehardware --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//homehardware.westus.azurecontainer.io:5656'
